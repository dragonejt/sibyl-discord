...
export default function embedPsychoPass(
        ...
        .addFields(
            {
                ...
                value: psychoPass.crime_coefficient.toString(),
            },
        ...
        .addFields(
            {
                ...
                value: psychoPass.severe_toxicity.toString(),
                inline: true,
            },
            {
                name: "Identity Attack",
                value: psychoPass.identity_attack.toString(),
                inline: true,
            },
            {
                name: "Insult",
                value: psychoPass.insult.toString(),
                inline: true,
            },
            { name: "\u200B", value: "\u200B" },
            {
                name: "Threat",
                value: psychoPass.threat.toString(),
                inline: true,
            },
            {
                name: "Profanity",
                value: psychoPass.profanity.toString(),
                inline: true,
            },
            {
                name: "Sexually Explicit",
                value: psychoPass.sexually_explicit.toString(),
                inline: true,
            }
        );
}
