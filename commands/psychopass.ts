...
async function execute(interaction: ChatInputCommandInteraction) {
    ...
    if (user) {
        ...
        else interaction.editReply({ embeds: [embedPsychoPass(psychoPass, interaction.client, interaction.user, user)] });
    } else {
        ...
        interaction.editReply({ embeds: [embedCommunityPsychoPass(psychoPass!, interaction.client, interaction.user, interaction.guild!)] });
    }
}
